...
userElem.send_keys('yohananof')
driver.find_element(By.CSS_SELECTOR, '#login-button').click()
time.sleep(2)

searchElem = driver.find_element(By.CSS_SELECTOR, '#fileList_filter > input')
...
xpath_selectors = [
    ...
    '/html/body/div[2]/div[2]/form/div[2]/table/tbody/tr[17]/td[1]/a',
    '/html/body/div[2]/div[2]/form/div[2]/table/tbody/tr[18]/td[1]/a',
    '/html/body/div[2]/div[2]/form/div[2]/table/tbody/tr[19]/td[1]/a'
]


today = date.today()
dir_to_save_files = os.path.join(r'C:\Users\Ariel\Desktop\Python\Kimonaim\yohananof', str(today))
